...
function initTranslation()
{
	...
	var e = document.getElementById("pin_error");
			...
			e.innerHTML = '<%asp_get("pinnumber");%>'+Get_string('Home Pin remain time 2');	
...
function isNum(item)
{
	...
	function pin_remain_time()
	{
		var pin_time_remain = '<%asp_get("pinnumber");%>';
		document.getElementById("pin_error").innerHTML = pin_time_remain+' times remaining for you to input PIN!';
	}
    </script>
    </head>
        ...
        <table class="mainTable" cellspacing="0" cellpadding="0" border="0" height="100%">
            <tr>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        <td class="listtopic" colspan="2" id="HomePin">PIN</td>
                    </tr>
                    <tr>
            			<td colspan="2">&nbsp;</td>
            		</tr>  
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        <td height="20" class="title"><span id="HomeVerifyPin">Verify PIN</span></td>
                    </tr>
                    <tr>
                        <td width="22%" valign="top" class="head_top">
                        <font face="Arial" id="HomePinInput"><b>PIN</b></font></td>
				...
				<td class="head_content" valign="top" width="78%"><font face="Arial" color="#000000"><div id="pin_error"></div></font></td>
				</tr>
                </table>
                <br>
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
